...
<head>
    ...
    <title>加拿大28大小 - 火车预测</title>
    <meta name="keywords"
          content="加拿大28火车预测,加拿大28大小预测,加拿大28贴吧交流,加拿大28预测软件,加拿大28走势图,加拿大28开奖查询,免费提供绿色、无广告的加拿大28预测交流网站!">
    ...
    <table class="table table-bordered">
        <tr>
            <td align="center"
                ...
                colspan="5"><a href="/"
                               style="color:#ff7373;">加拿大28大小 - 火车预测</a></td>
        </tr>
        <tr>
            <td align="center"
        ...
        <c:forEach items="${CanadaYuce}" var="canadaYc" begin="0" end="0">
            <tr>
                ...
                <td>
                    <c:choose>
                        <c:when test="${canadaYc.yuce>=14}">
                            <div style="width:100%;height:100%;text-align: center;">
                                <strong>大</strong>
                            </div>
                        </c:when>
                        <c:when test="${canadaYc.yuce<=13}">
                            <div style="width:100%;height:100%;text-align: center;">
                                <strong>小</strong>
                            </div>
                        </c:when>
        ...
        <c:forEach items="${CanadaYuce}" var="canadaYc" begin="1" end="30">
            <tr>
                ...
                <td align="center">
                    <c:choose>
                        <c:when
                                test="${(canadaYc.yuce>=14&&canadaYc.result>=14)||(canadaYc.yuce<=13&&canadaYc.result<=13)}">
                            <div style="width:100%;height:100%;text-align: center;">
...
<script type="text/javascript">
    function AutoRefresh() {
        ...
        if ((m == 1 && s == 1) || (m == 4 && s == 1)
            ...
            || (m == 47 && s == 1) || (m == 50 && s == 1)
            || (m == 53 && s == 1) || (m == 57 && s == 1)) {
            location.href = "/Canada/CanadaDxYuce.html";
        }
    }
