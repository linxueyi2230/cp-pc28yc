    ...
    <table class="table table-bordered">
        <tr>
            <td align="center"
                ...
                colspan="5"><a href="/"
                               style="color:#ff7373;">PC蛋蛋大小 - 火车预测</a></td>
        </tr>
        <tr>
            <td align="center"
        ...
        <c:forEach items="${KenoYuce}" var="kenoYc" begin="0" end="0">
            <tr>
                ...
                <td>
                    <c:choose>
                        <c:when test="${kenoYc.yuce>=14}">
                            <div style="width:100%;height:100%;text-align: center;">
                                <strong>大</strong>
                            </div>
                        </c:when>
                        <c:when test="${kenoYc.yuce<=13}">
                            <div style="width:100%;height:100%;text-align: center;">
                                <strong>小</strong>
                            </div>
                        </c:when>
        ...
        <c:forEach items="${KenoYuce}" var="kenoYc" begin="1" end="30">
            <tr>
                ...
                <td align="center">
                    <c:choose>
                        <c:when
                                test="${(kenoYc.yuce>=14&&kenoYc.result>=14)||(kenoYc.yuce<=13&&kenoYc.result<=13)}">
                            <div style="width:100%;height:100%;text-align: center;">
...
<script type="text/javascript">
    function AutoRefresh() {
        ...
        if ((m == 1 && s == 1) || (m == 6 && s == 1) || (m == 11 && s == 1) || (m == 16 && s == 1) || (m == 21 && s == 1) || (m == 26 && s == 1) || (m == 31 && s == 1) || (m == 36 && s == 1) || (m == 41 && s == 1) || (m == 46 && s == 1) || (m == 51 && s == 1) || (m == 56 && s == 1)) {
            location.href = "/Keno/KenoDxYuce.html";
        }
    }
