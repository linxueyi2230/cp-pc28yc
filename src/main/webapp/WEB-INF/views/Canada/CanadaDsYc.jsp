...
<head>
    ...
    <title>加拿大28单双 - 火车预测</title>
    <meta name="keywords"
          content="加拿大28火车预测,加拿大28单双预测,加拿大28贴吧交流,加拿大28预测软件,加拿大28走势图,加拿大28开奖查询,免费提供绿色、无广告的加拿大28预测交流网站!">
    ...
    <table class="table table-bordered">
        <tr>
            <td align="center"
                ...
                colspan="5"><a href="/"
                               style="color:#ff7373;">加拿大28单双 - 火车预测</a></td>
        </tr>
        <tr>
            <td align="center"
        ...
        <c:forEach items="${CanadaYuce}" var="canadaYc" begin="1" end="30">
            <tr>
                ...
                <td align="center">
                    <c:choose>
                        <c:when
                                test="${(canadaYc.yuce%2==0&&canadaYc.result%2==0)||(canadaYc.yuce%2!=0&&canadaYc.result%2!=0)}">
                            <div style="width:100%;height:100%;text-align: center;">
...
<div id="ban">
    <ul class="list-inline" style="text-align: center;padding-top: 6px;">
        ...
        <li>
            <button type="button" class="btn" onclick="window.location.href='/Canada/CanadaDsYuceChange.html'">
                更换算法
            </button>
        </li>
        <li>
            <button type="button" class="btn" onclick="window.location.href='/Canada/CanadaDsYuce.html'">
                刷新
            </button>
        </li>
    </ul>
...
<script type="text/javascript">
    function AutoRefresh() {
        ...
        if ((m == 1 && s == 1) || (m == 4 && s == 1)
            ...
            || (m == 47 && s == 1) || (m == 50 && s == 1)
            || (m == 53 && s == 1) || (m == 57 && s == 1)) {
            location.href = "/Canada/CanadaDsYuce.html";
        }
    }
